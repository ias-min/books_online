...
export default function NovelaScreen() {
  ...
  return (
    <View style={styles.container}>
      <View>
        ...
        <Text style={styles.generos}>Novela</Text>
      </View>
      <View>
      ...
      <View style={styles.alinhar}>
        <View style={styles.viewLivros}>
          <Image
            style={styles.livros}
            source={require('../image/metamorfose.jpeg')}
          />
        </View>
        <View>
          <Text style={styles.txtBold}>Título:</Text>
          <Text style={styles.txtNome}>A Metamorfose</Text>
          <Text style={styles.txtBold}>Autor(es):</Text>
          <Text style={styles.txtNome}>Franz Kafka</Text>
          <Text style={styles.txtBold}>Lançamento:</Text>
          <Text style={styles.txtNome}>1915</Text>
        </View>
      </View>
      ...
      <View style={styles.alinhar}>
        <View style={styles.viewLivros}>
          <Image
            style={styles.livros}
            source={require('../image/gabriela.jpeg')}
          />
        </View>
        <View>
          <Text style={styles.txtBold}>Título:</Text>
          <Text style={styles.txtNome}>Gabriela, Cravo e Canela</Text>
          <Text style={styles.txtBold}>Autor(es):</Text>
          <Text style={styles.txtNome}>Jorge Amado</Text>
          <Text style={styles.txtBold}>Lançamento:</Text>
          <Text style={styles.txtNome}>1958</Text>
        </View>
      </View>
      <TouchableOpacity style={styles.buttonLer} onPress={handleLerButton}>
        <Text style={styles.buttonText}>Ler</Text>
