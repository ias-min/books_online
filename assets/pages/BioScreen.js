  ...
  return (
    <View style={styles.container}>
      <View>
        ...
        <Text style={styles.generos}>Biografia</Text>
      </View>
      <View>
      ...
      <View style={styles.alinhar}>
        <View style={styles.viewLivros}>
          <Image
            style={styles.livros}
            source={require('../image/anne.jpeg')}
          />
        </View>
        <View>
          <Text style={styles.txtBold}>Título:</Text>
          <Text style={styles.txtNome}>Diário de Anne Freank</Text>
          <Text style={styles.txtBold}>Autor(es):</Text>
          <Text style={styles.txtNome}>Anne Freank</Text>
          <Text style={styles.txtBold}>Lançamento:</Text>
          <Text style={styles.txtNome}>1947</Text>
        </View>
      </View>
      ...
      <View style={styles.alinhar}>
        <View style={styles.viewLivros}>
          <Image
            style={styles.livros}
            source={require('../image/rita.jpeg')}
          />
        </View>
        <View>
          <Text style={styles.txtBold}>Título:</Text>
          <Text style={styles.txtNome}>Rita Lee: Autobiografia</Text>
          <Text style={styles.txtBold}>Autor(es):</Text>
          <Text style={styles.txtNome}>Rita Lee</Text>
          <Text style={styles.txtBold}>Lançamento:</Text>
