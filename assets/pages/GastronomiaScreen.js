  ...
  return (
    <View style={styles.container}>
      <View>
        ...
        <Text style={styles.generos}>Gastronomia</Text>
      </View>
      <View>
      ...
      <View style={styles.alinhar}>
        <View style={styles.viewLivros}>
          <Image
            style={styles.livros}
            source={require('../image/sextas.jpeg')}
          />
        </View>
        <View>
          <Text style={styles.txtBold}>Título:</Text>
          <Text style={styles.txtNome}>Todas as sextas</Text>
          <Text style={styles.txtBold}>Autor(es):</Text>
          <Text style={styles.txtNome}>Paula Carosella</Text>
          <Text style={styles.txtBold}>Lançamento:</Text>
          <Text style={styles.txtNome}>2016</Text>
        </View>
      </View>
      ...
      <View style={styles.alinhar}>
        <View style={styles.viewLivros}>
          <Image
            style={styles.livros}
            source={require('../image/cozinha.jpeg')}
          />
        </View>
        <View>
          <Text style={styles.txtBold}>Título:</Text>
          <Text style={styles.txtNome}>Na cozinha</Text>
          <Text style={styles.txtBold}>Autor(es):</Text>
          <Text style={styles.txtNome}>Juniana Gueiros</Text>
          <Text style={styles.txtBold}>Lançamento:</Text>
          <Text style={styles.txtNome}>2024</Text>
        </View>
      </View>
      <TouchableOpacity style={styles.buttonLer} onPress={handleLerButton}>
        <Text style={styles.buttonText}>Ler</Text>
